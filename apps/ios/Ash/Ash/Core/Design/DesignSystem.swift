...
extension Color {
    /// Primary app accent color - indigo for professional, secure appearance
    static let ashAccent = Color(uiColor: .systemIndigo)
    ...
    static let ashSecure = Color(uiColor: .systemIndigo)
}
...
enum ConversationColor: String, Codable, CaseIterable, Sendable, Identifiable {
    case indigo     // Default - professional, secure appearance
    case blue
    case purple
    case teal
    case green
    ...
    var color: Color {
        ...
        case .orange: return Color(red: 0.90, green: 0.55, blue: 0.30)
